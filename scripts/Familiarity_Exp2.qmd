  ...
  if (choice_rule=="softmax") {
    ...
    if (model == "linear") {
      M3_formula <- bf(
        ...
        nlf(TransOld ~ a + b),
        nlf(TransNew ~ a + b),
        nlf(OutSame ~ iP*(inv_logit(ra)*a + inv_logit(rc)*c1 + b)),
      ...
      M3_formula <- bf(
        ...
        nlf(TransOld ~ a1 + b),
        nlf(TransNew ~ a2 + b),
        nlf(OutSame ~ iP*(ra*a1 + rc*c1 + b)),
        nlf(OutOther ~ ra*a1 + b),
        nlf(NPL ~ b),
        nlf(a1 ~ ya1 + exp(ba1)*t),
        nlf(a2 ~ ya2 + exp(ba2)*t),
  ...
  if (choice_rule=="softmax") {
    if (model == "linear") {
      ...
      M3_prior <- c(
        ...
        prior(normal(-1,0.5), class = "b", nlpar = "ba1"),
        prior(normal(3,1), class = "b", nlpar = "ya2"),
        prior(normal(-1,0.5), class = "b", nlpar = "ba2"),
...
smart_runFun(
  ...
  args = list(
    ...
    sample_prior = "yes",
    init = 0,
    file = paste0(model_path, "Model_Exp2_M3_Softmax_nonlinear")
    ),
  name = "Model_Exp2_M3_Softmax_nonlinear"
)
