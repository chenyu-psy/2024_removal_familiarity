...
#'
#'
smart_runBrms <- function(
    formula=NULL, data=NULL, model=null, prior=NULL, 
    ..., 
    model_path, model_name, log_path = model_path, 
    priority = 1, maxCore = NULL, checkInt = 30){
  ...
  if (!file.exists(log_file)) {
    ...
    readr::write_rds(Table_job_status, log_file)
